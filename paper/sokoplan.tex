...
\item \verb *(box_at ?a - square)* meaning that there is a box at square "a"
\item \verb *(worker_at ?a - square)* meaning that there is the worker at square "a"
\end{enumerate}
...
\verb *(opt_box ?s - square)* for boxes, and \verb *(opt_worker ?s - square)* for the worker.
...
where they wish to place their item.
