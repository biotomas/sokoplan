...
To transform a level template into solvable level will be task of the automated planner. In order to do this
...
phase. No more walls, boxes or workers can be added after this action is executed. Move and push actions
...
we need to add according to the level template. For example, if need to add 3 walls and 5 boxes, then
we declare 3 objects of type wall and 5 objects of type box. Then with the help of two new predicates:
